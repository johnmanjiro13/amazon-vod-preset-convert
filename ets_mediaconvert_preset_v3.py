...
def validation_region():
    ...
    if not args.interactive:
        ...
        while True:
            ...
            if region.strip() in ['us-east-1', 'us-west-1', 'us-west-2', 'eu-west-1', 'ap-southeast-1', 'ap-southeast-2', 'ap-south-1', 'ap-northeast-1']:
                return region
...
def validate_output(outputtype):
    if args.interactive:
        while True:
            emf_outputgroup = input("Please type in output a output group type you want to place this ETS preset into, options are file, apple, dash, smooth: ")
...
def translate_audio(ets_preset_payload, s_audio):
    ...
    ###Type MP2
        ...
        if emf_sample != 'auto':
            ...
            print("Auto in setting Sample Rate not supported...defaulting to 48000kHz\n")
...
emf_PresetSettings = translate_container(emf_AudioDescription, emf_VideoDescription, s_container, emf_outputgroup, s_video)
